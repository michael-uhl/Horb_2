...
public class IsInputNumberEvenValidationImpl extends IsInputNumberEvenValidator implements DocumentListener {
	
	private JTextComponent source;
	
	public IsInputNumberEvenValidationImpl(JTextComponent source) {
		this.source = source;
	}
